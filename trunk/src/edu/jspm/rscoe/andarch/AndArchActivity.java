...
public class AndArchActivity extends AndARActivity implements SurfaceHolder.Callback {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_ROTATE_X, 0, res.getText(R.string.rotate_x))
    		.setIcon(R.drawable.rotate);
        menu.addSubMenu(0, MENU_ROTATE_Y, 0,res.getText(R.string.rotate_y) )
       		.setIcon(R.drawable.rotate);
        menu.addSubMenu(0, MENU_ROTATE_Z, 0,res.getText(R.string.rotate_z) )
        	.setIcon(R.drawable.rotate);
             return true;
    }
